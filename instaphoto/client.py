...
def buy_file():
	...
	try:
		sel = input("Please enter the index of the file tha you would like to buy: ")
		
		# check if the input index is avlid key in file_dict
		if sel in file_list:
			print('You selected {} in our database'.format(file_list[sel][0]))
			
			# create a 402-payable request with the server pauout address
			...
			if answer.status_code != 200:
				...
				# open a file with the same name as the file being urchased in stream the data into it.
			...
			print("Thas is an invalid selection.")
	except ValueError:
